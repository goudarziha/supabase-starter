        ...
        >
          <Box flex="1" maxW={{ lg: '520px' }}>
            ...
            <Heading
              ...
              letterSpacing="tight"
            >
              Create your own custom workout journal
            </Heading>
            <Text
              ...
              fontWeight="medium"
            >
              Build from other battle-tested workouts, or start from scratch
            </Text>
          ...
          >
            <Img
              ...
              h={{ lg: '100%' }}
              objectFit="cover"
              src="https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"
